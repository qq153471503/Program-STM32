...
extern u8 Max_Lun;	//支持的磁盘个数,0表示1个,1表示2个.
 ...
 {	 
  ...
  NVIC_PriorityGroupConfig(NVIC_PriorityGroup_2);//设置中断优先级分组为组2：2位抢占优先级，2位响应优先级
	...
	LCD_ShowString(30,50,200,16,16,"USB Card Reader TEST");	
	LCD_ShowString(30,70,200,16,16,"D545-liuAnkun");
	LCD_ShowString(30,90,200,16,16,"2017/1/6");	

   if(exf_getfree("0",&size1,&size2))		//获取容量	
	{
		LCD_ShowString(30,110,200,16,16,"FATFS Error!");
		delay_ms(200);
	...
	{
		LCD_Fill(30,130,240,150+16,WHITE);
		LCD_ShowString(30,110,200,16,16,"FATFS Successful!");
	}
	...
	{   
		LCD_ShowString(20,130,200,16,16,"SD Card check successful !!!");
		LCD_ShowString(20,150,200,16,16,"SD Card Size:     MB");
	    ...
	    Mass_Block_Count[0]=Mass_Memory_Size[0]/Mass_Block_Size[0];
 		LCD_ShowNum(122,150,Mass_Memory_Size[0]>>20,5,16);	//显示SD卡容量
		
		LCD_ShowString(20,170,200,16,16,"Remaining space:       MB");	//剩余容量
	...
	LCD_ShowString(30,190,200,16,16,"USB Connecting...");	//提示USB开始连接	
	...
	{	
		...
		{	 						   
			...
			if(USB_STATUS_REG&0x04)
				...
				LCD_Fill(30,230,260,230+16,WHITE);//清除显示
		...
		{
			if(bDeviceState==CONFIGURED)LCD_ShowString(30,190,200,16,16,"USB Connected    ");//提示USB连接已经建立
		...
		if(!KEY0)
		{
			...
			if(!KEY0)
			{
				...
				{
					LED1 = 0;
					LCD_ShowString(20,250,200,16,16,"SD Card Formating...");					
				}while(mf_fmkfs("0:",1,4096));                                  
                 LED1 = 1;                                                   
				LCD_ShowString(20,250,200,16,16,"Format Successful !!");
			}
		}		
