...
////wide:		图片宽度
////high:		图片高度
//void LcdDrawPicture(u16 StartX,u16 StartY,u16 wide,u16 high)
//{
//	u32 i;

//	LCD_Set_Window(StartX,StartY,wide,high);
//	LCD_WriteRAM_Prepare();		
//	while(i<wide*high)
//	{
//		LCD_WR_DATA((meheng[2*i]<<8)+(meheng[2*i+1]));/*组合为16位数据像素点*/
//		i++;
//	}
...
{ 					
  ...
  FSMC_NORSRAMInit(&FSMC_NORSRAMInitStructure);  //初始化FSMC配置
	...
	LCD_Display_Dir(1);		/*默认为竖屏	===================================在此处修改横竖屏幕======================================================================================*/
	LCD_LED=1;				//点亮背光
	LCD_Clear(WHITE);
}  
//清屏函数
