...
//led0任务
#define space_TASK_PRIO		4
#define space_STK_SIZE 		64
OS_TCB spaceTaskTCB;
CPU_STK space_TASK_STK[space_STK_SIZE];
void space_task(void *p_arg);
...
void start_task(void *p_arg)
{
   ...
   OSStatTaskCPUUsageInit(&err);  	//统计任务                
	...
	OSTaskCreate((OS_TCB 	* )&spaceTaskTCB,		
				 (CPU_CHAR	* )"space task", 		
                 (OS_TASK_PTR )space_task, 			
                 (void		* )0,					
                 (OS_PRIO	  )space_TASK_PRIO,     
                 (CPU_STK   * )&space_TASK_STK[0],	
                 (CPU_STK_SIZE)space_STK_SIZE/10,	
                 (CPU_STK_SIZE)space_STK_SIZE,		
                 (OS_MSG_QTY  )0,					
                 (OS_TICK	  )0,					
                 (void   	* )0,					
                 (OS_OPT      )OS_OPT_TASK_STK_CHK|OS_OPT_TASK_STK_CLR,
