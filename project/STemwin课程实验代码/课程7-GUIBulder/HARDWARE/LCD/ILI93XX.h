...
typedef struct  
{										    
	u16 width;			//TFT_LCD 宽度
	u16 height;			//TFT_LCD 高度
	u16 id;				//TFT_LCD ID
...
//TFT_LCD参数
extern _lcd_dev lcddev;	//管理TFT_LCD重要参数
//TFT_LCD的画笔颜色和背景色	   
...
//////////////////////////////////////////////////////////////////////////////////	 
//-----------------TFT_LCD端口定义---------------- 
#define	LCD_LED PBout(0) //TFT_LCD背光  PB0 	    
//TFT_LCD地址结构体
typedef struct
{
	vu16 LCD_REG;
...
//注意设置时STM32内部会右移一位对其! 			    
#define TFT_LCD_BASE        ((u32)(0x6C000000 | 0x000007FE))
#define TFT_LCD             ((LCD_TypeDef *) TFT_LCD_BASE)
//////////////////////////////////////////////////////////////////////////////////
...
//TFT_LCD分辨率设置
#define SSD_HOR_RESOLUTION		800		//TFT_LCD水平分辨率
#define SSD_VER_RESOLUTION		480		//TFT_LCD垂直分辨率
//TFT_LCD驱动参数设置
